...
import { Eye, EyeOff, Loader2, CheckCircle, AlertCircle, Zap, ArrowRight, Sparkles } from 'lucide-react';
...
const AuthPage = () => {
  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden bg-background">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground lg:w-1/2">
